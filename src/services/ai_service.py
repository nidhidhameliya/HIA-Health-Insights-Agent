    ...
    if "chat_agent" not in st.session_state:
        try:
            ...
            if not get_secret("GROQ_API_KEY"):
                ...
                st.session_state.chat_agent_error = "GROQ_API_KEY not found in Streamlit secrets or environment variables. Please add it to .streamlit/secrets.toml or export it before running the app."
            else:
