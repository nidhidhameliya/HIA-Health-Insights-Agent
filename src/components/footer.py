...
def get_github_stars():
    try:
        response = requests.get("https://api.github.com/repos/nidhidhameliya/HIA-Health-Insights-Agent")
    ...
    st.markdown(
        ...
        <div style='{base_styles}'>
            ...
            '>
                ...
                ">
                    <a href='https://github.com/nidhidhameliya/HIA-Health-Insights-Agent' 
                       target='_blank' 
                       style='
                           color: #64B5F6;
